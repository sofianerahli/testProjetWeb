...
<h2 align="center"><big>Livres</big></h2>
<?php
$database = "ece_amazon";
...
$db_found = mysqli_select_db($db_handle, $database );
	if($db_found)
	{
		$SQL="SELECT * FROM item WHERE Categorie='Livres' ORDER BY Id DESC";
...
<div style="background:white;width:45% ; padding: 0.5%;
    margin-left: auto;
    margin-right: auto;
    border: 1px solid #f1f1f1;
    background: #fff;
    box-shadow: 0 0 20px 0 rgba(0, 0, 0, 0.2), 0 5px 5px 0 rgba(0, 0, 0, 0.24);box-sizing: border-box;">
    	<h3 align ="center"><?php echo $db_field['Nom'];?></h3><br/>
