...
<h2 align="center"><big>Sport & Loisirs</big></h2>
<?php
$database = "ece_amazon";
...
$db_found = mysqli_select_db($db_handle, $database );
	if($db_found)
	{
		$SQL="SELECT * FROM item WHERE Categorie='Sport&Loisirs' ORDER BY Id DESC";
...
<div style="background:white;width:40% ; padding: 0.5%;
    margin-left: auto;
    margin-right: auto;
